/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6be1f92d2bd94aa101e0cd5d56c14dfa)
// Runtime types generated with workerd@1.20260317.1 2026-03-25 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SHARES: KVNamespace;
		SHARE_BUNDLES: R2Bucket;
		SHARED_AI_RATE_LIMIT: RateLimit;
		OPENROUTER_SITE_URL: "https://pdfation.yet-to-be.com";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENROUTER_SITE_URL" | "OPENROUTER_API_KEY">> {}
}
